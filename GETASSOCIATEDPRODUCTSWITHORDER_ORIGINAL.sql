...
BEGIN
    ...
    SELECT @MOBILESERVERPRODUCTLISTORGANIZATIONID = APPLICATIONCONFIGVALUE FROM APPLICATIONCONFIGVALUE WITH (NOLOCK)
    WHERE APPLICATIONCONFIGNAME='MOBILESERVERPRODUCTLISTORGANIZATIONIDS'

    SELECT @RECENTCOUNT=CAST(APPLICATIONCONFIGVALUE AS int) FROM APPLICATIONCONFIGVALUE WITH (NOLOCK)
    WHERE APPLICATIONCONFIGNAME='MOBILESERVERPRODUCTLISTCOUNT'
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                CP.PRODUCTID , CP.SERIALNUMBER , CP.PRODUCTFAMILY 'PRODUCTFAMILY', PRODUCTLINE, ACTIVEPROMOTION
                FROM CUSTOMERPRODUCTSSUMMARY CP WITH ( NOLOCK )
    ...
    -- Additional logic for other ASSOCTYPEID values would continue here...
    -- [The rest of the stored procedure would follow the same pattern]
